        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="foodinfo">
            ...
            <div class="try">
              <q-input 
              outlined 
              v-model="food_name" disable readonly
              />
            </div>
            ...
            <q-input 
              outlined 
              v-model="others" disable readonly
            />
            </div>
            ...
            <div class="col custom">
              <div class="trynew"> 
              <q-select outlined v-model="advanced_macro_category" :options="selectinput1array" disable readonly/>
              </div>
              ...
              <q-select outlined v-model="dietary_fiber" :options="selectinput2array"  @input="setService_size" disable readonly/>
            ...
            <div class="row" v-for="(servings, k) in servingArr" :key="k">
                  <div class="col">
                    ...
                    <div class="try">
                      <q-input 
                      outlined 
                      v-model="servings.service_name" disable readonly
                      />
                    </div>
                  </div>
                  <div class="col">
                    ...
                    <div class="try50 flex justify-between">
                      ...
                      outlined 
                       type="number"
                      v-model="servings.service_size" disable readonly
                      />
                     </div>
                  </div>
              </div>
