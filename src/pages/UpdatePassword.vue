...
<div>
       <div >
  <h5 align="center" style="margin-top:5%;">Update Password</h5>
    </div>  
...
import axios from "axios";
 export default {
   ...
   mounted() {
          ...
          axios
          .get(
          this.$API_URL + "editpassword"+'/'+token,
          {
      ...
      {   
                    ...
                    else
                    {
                        ...
                        .then(response => {
                            ...
                            Vue.$toast.success("Password has been updated successfully.",{position:"top-right"});
