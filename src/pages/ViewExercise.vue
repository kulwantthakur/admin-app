<template>
<q-card>
 <h5 align="center" style="margin-top:0;">View Exercise</h5>
        <q-tabs
          v-model="tabexercise"
          dense
          class="text-grey"
        ...
        <q-separator />
         ...
         <q-tab-panel name="basicinfo">
            ...
            <div class="try">
              <q-input 
              outlined 
              v-model="exercise_name" disable readonly
              />
            </div>
            ...
            <q-input 
              outlined 
              v-model="video_link" disable readonly
              />
              </div>
          ...
          <div v-if="submitted && !$v.video_link.required" class="invalid-feedback">Video Link is required</div>
            ...
            <q-input 
              outlined 
              v-model="instruction" disable readonly
            />
            </div>
            ...
            <br />
            <q-radio size="xs" v-model="competition_lift" val="true" label="Yes" @input="disabletrue()" id="competition_lift_true" disable readonly/>
            <q-radio size="xs" v-model="competition_lift" val="false" label="No" @input="disablefalse()" id="competition_lift_false" disable readonly/>

            </div>
            <div class="col-4">
            <label>Track as Competition Lift?</label>
            <br />
            <q-select class="q-mb-lg" outlined v-model="movement_category" :options="movementcategoryarray" :disable="disabled" disable readonly id="movement_category_active"/>
                ...
                <div class="try">
                <q-select outlined v-model="measured_parameter" :options="measuredarray" disable readonly />  
                </div>
