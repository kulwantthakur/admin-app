...
<q-card>
        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="business">
            <div >
  <h5 align="center" style="margin-top:0;">Edit Head Coach</h5>
      ...
      <div v-if="submitted && !$v.contact_email.required" class="invalid-feedback">Email is required</div>
       ...
       <br />
        ...
        <q-btn label="Back" color="primary" @click=gotolicencing() />  
                   <q-btn style="float:right;" label="Update" color="primary" @click=finalsave() />
...
import Vue from "vue";
  ...
  methods: {
    ...
    if(!this.$v.country.$invalid && !this.$v.state.$invalid && !this.$v.post_code.$invalid && !this.$v.company_name.$invalid && !this.$v.website.$invalid && !this.$v.work_number.$invalid && !this.$v.contact_name.$invalid && !this.$v.contact_mobile.$invalid && !this.$v.address.$invalid && !this.$v.email.$invalid && !this.$v.abn.$invalid && !this.$v.contact_phonenuumber.$invalid && !this.$v.contact_email.$invalid && this.athlete_licences != 'Please select' && this.assistant_licences != 'Please select' && this.abn.length == 10 && this.logo != '' && this.photo != '') 
     {
            ...
            data.append('uploadlogo', this.uploadlogo);
            data.append('uploadphoto', this.uploadphoto);
            ...
            data.append('headID', this.$route.params.id);


       axios
        .post(
          this.$API_URL+"updateheadcoaches", data,{
            headers: {
   ...
   updatesave() {   
        if(!this.$v.company_name.$invalid && !this.$v.website.$invalid && !this.$v.work_number.$invalid && !this.$v.contact_name.$invalid && !this.$v.contact_mobile.$invalid && !this.$v.address.$invalid && !this.$v.email.$invalid && !this.$v.abn.$invalid && !this.$v.contact_phonenuumber.$invalid && !this.$v.assigned_coach.$invalid && this.athlete_licences != 'Please select' && this.assistant_licences != 'Please select' && this.abn.length == 10) 
     {
           var id = this.$route.params.id;
           axios
        .put(
          this.$API_URL+"headcoaches"+'/'+id, 
          {
            ...
            contact_phonenuumber:this.contact_phonenuumber,
            assistant_licences:this.assistant_licences,
            athlete_licences:this.athlete_licences,
            state:this.state,
